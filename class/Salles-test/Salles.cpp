...
std::vector<Point> contourList1 = {Point(384,0),Point(480,0),Point(480,96),Point(1104,96),Point(1104,192),Point(1280,192),Point(1280,336),Point(1152,336),Point(1152,528),Point(1200,528),Point(1200,576),Point(1152,576),Point(1152,672),Point(624,672),Point(624,576),Point(528,576),Point(528,672),Point(480,672),Point(480,576),Point(384,576),Point(384,672),Point(144,672),Point(144,576),Point(336,576),Point(336,480),Point(144,480),Point(144,384),Point(240,384),Point(240,288),Point(144,288),Point(144,96),Point(288,96),Point(288,48),Point(336,48),Point(336,0),Point(384,0)};
std::vector<Rectangle> obstacleList1 = {Rectangle(Point(144+48,288+48), 96, 96),Rectangle(Point(480+48,144+48), 96, 96),Rectangle(Point(480+48,240+48), 96, 96),Rectangle(Point(336+48,384+48), 96, 96),Rectangle(Point(432+48,432+48), 96, 96),Rectangle(Point(528+48,144+48), 96, 96),Rectangle(Point(768+48,288+48), 96, 96),Rectangle(Point(816+48,384+48), 96, 96),Rectangle(Point(720+48,480+48), 96, 96),Rectangle(Point(816+48,528+48), 96, 96)};
std::string nom1 = "map1.png";
std::vector<Point> ES1 = {Point(384, 50), Point(1200, 240)};
std::vector<Point> spawnable1 = {Point(1100,240),Point(624,480),Point(816,192),Point(240,192)}; 
...
std::vector<Rectangle> obstacleList2 = {Rectangle(Point(672+48,240+48),96,96)};
std::string nom2 = "map2.png";
std::vector<Point> ES2 = {Point(50, 240), Point(1200, 388)};
std::vector<Point> spawnable2 = {Point(1150,432),Point(480,192),Point(864,384)};
...
std::vector<Rectangle> obstacleList3 = {Rectangle(Point(336+48,240+48), 96, 96), Rectangle(Point(528+48,240+48), 96, 96), Rectangle(Point(672+48,432+48), 96, 96), Rectangle(Point(912+48,336+48), 96, 96)};
std::string nom3 = "map3.png";
std::vector<Point> ES3 = {Point(0, 432), Point(864, 10)};
std::vector<Point> spawnable3 = {Point(864,10),Point(960,528),Point(768,288),Point(432,480)};
